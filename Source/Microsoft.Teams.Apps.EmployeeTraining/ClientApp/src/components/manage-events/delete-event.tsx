// <copyright file="delete-event.tsx" company="Microsoft">
...
import { deleteEventAsync } from "../../api/manage-events-api";
import { ResponseStatus } from "../../constants/constants";

/** Renders component to delete event */
const DeleteEvent: React.FunctionComponent = props => {
    ...
    const deleteEvent = async () => {
        ...
        let response = await deleteEventAsync(teamId!, eventId!);
